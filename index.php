            ...
            <div class="content position-fixed">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        ?>
                        <a href="profile.php" class="btn btn-outline-light btn-lg shadow-sm">See Profile</a>
                    </div>
                </div><hr class="socket"> <!-- End Card -->
            </div> <!-- End Content -->
